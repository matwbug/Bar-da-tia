...
import { NavNotLogged } from "./components/nav-not-logged"; // Importa o componente de navegação para usuários não autenticados
import { CartNavbar } from "./components/cart-navbar"; // Importa o componente que controla o carrinho
          ...
          <NavbarContent className="hidden sm:flex" justify="center"> {/* Define o conteúdo da barra de navegação no centro */}
            <NavbarItem className="w-fit">
              <Input
                ...
                size="sm"
                startContent={<Search size={18} />} // Adiciona o ícone de pesquisa à esquerda do campo de entrada
                type="search"
                value={search}
