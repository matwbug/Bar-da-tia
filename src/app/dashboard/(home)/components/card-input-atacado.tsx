...
export const CardInputAtacado = ({produto, setProduto, formData, setFormData, variant}: {
    ...
    const defaultValue = variant === 'add' ? (formData?.atacado_minquantidade ? formData?.atacado_minquantidade : 0) : variant === 'edit' ? (produto?.atacadoMinQuantidade ? produto?.atacadoMinQuantidade : 0) : 0
    ...
    return(
        ...
        <div className="flex flex-row gap-2 items-start w-full  rounded-md p-4">
            <div className="flex flex-col gap-2 w-full">
                ...
                <p className="flex flex-row gap-1 items-center">Atacado <ShoppingCart size={20} /></p>
                {/* Descrição da opção */}
            ...
            <Switch 
                ...
                onChange={(e) => {
                    ...
                    if(produto && setProduto && variant === 'edit'){} /* setProduto({...produto, atacado: e.target}) */
